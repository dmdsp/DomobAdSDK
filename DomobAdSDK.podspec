#
# Be sure to run `pod lib lint DomobAdSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #  s.source_files = 'DomobAdSDK/Classes/**/*'
  ...
  s.subspec 'DMAdSDK' do |dmadsdk|
    ...
    dmadsdk.vendored_frameworks = 'DomobAdSDK/Classes/DMAdSDK.xcframework'
    
    dmadsdk.resource_bundles = {
        'DMAdSDK_Bundle' => ['DomobAdSDK/Classes/DMAdSDK_Bundle.bundle/**/*']
    }
  end
  
  s.subspec 'DomobSDKAdapter' do |domobsdkadapter|
    # 添加 DMengSDKAdapter 的其他配置信息
    domobsdkadapter.dependency 'DomobAdSDK/DMAdSDK'
    domobsdkadapter.vendored_frameworks = 'DomobAdSDK/Classes/DomobSDKAdapter.xcframework'
  ...
  s.subspec 'GMAdSDKAdapter' do |gmadsdkadapter|
    ...
    gmadsdkadapter.dependency 'DomobAdSDK/DomobSDKAdapter'
    gmadsdkadapter.ios.deployment_target = '12.0'

    gmadsdkadapter.vendored_frameworks = 'DomobAdSDK/Classes/GMAdSDKAdapter.xcframework'
  ...
  s.subspec 'KSAdSDKAdapter' do |ksadsdkadapter|
    ...
    ksadsdkadapter.dependency 'DomobAdSDK/DomobSDKAdapter'
    ksadsdkadapter.ios.deployment_target = '12.0'

    ksadsdkadapter.vendored_frameworks = 'DomobAdSDK/Classes/KSAdSDKAdapter.xcframework'
